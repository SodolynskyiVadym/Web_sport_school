          ...
          <div class="layout">
            <div class="layout_item w-50">
              <div class="newsletter">
                <h3 class="newsletter_title">Empowering Tomorrow's Athletes Today</h3>
                <form action="">
                  <input type="text" placeholder="Join to our sport school">
                  <button>
            ...
            <div class="layout_item w-25">
              <nav class="c-nav-tool">
                ...
                <ul class="c-nav-tool_list">
                  ...
                  <li>
                    <a href="/groups" class="c-link">Groups</a>
                  </li>

                  <li>
                    <a href="/coaches" class="c-link">Coaches</a>
                  </li>
                  <li>
                    <a href="/schedule" class="c-link">Schedule</a>
                  </li>
                </ul>
              </nav>
            ...
            <div class="layout_item w-25">
              <nav class="c-nav-tool">
                <h4 class="c-nav-tool_title">Opening Hours</h4>
                <ul class="c-nav-tool_list">

                  <li class="c-nav-tool_item">
                    <a href="/pages/shipping-returns" class="c-link"> Monday 9:00-19:00</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/help" class="c-link">Tuesday 9:00-19:00</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/terms-conditions" class="c-link">Wednesday 9:00-19:00</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/privacy-policy" class="c-link">Thursday 9:00-19:00</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/contact" class="c-link">Friday 9:00-19:00</a>
                  </li>
...
.footer_inner {
  ...
  border: 0.1px solid rgba(230, 230, 230,0.99);
  border-radius: 5px;
  padding: 2rem;
  margin: 1rem 0;
}
